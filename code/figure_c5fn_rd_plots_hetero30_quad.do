...
graph export "${path}\output\rd_plot_second10_msharelow_30threshold_quad.eps", as(eps) preview(on) replace
...
graph export "${path}\output\rd_plot_second10_msharehigh_30threshold_quad.eps", as(eps) preview(on) replace
