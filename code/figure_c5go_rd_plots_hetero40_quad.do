...
graph export "${path}\output\rd_plot_second10_msharelow_40threshold_quad.eps", as(eps) preview(on) replace
...
graph export "${path}\output\rd_plot_second10_msharehigh_40threshold_quad.eps", as(eps) preview(on) replace
