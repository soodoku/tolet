...
reghdfe toiletuse female c.muslim_share#c.female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 1 & b2_3 != 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toiletpref_muslimshare.tex", replace
summ toiletuse if e(sample)==1
reghdfe toiletuse female c.muslim_share#c.female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 1 & b2_3 != 1, a(hhid e8) vce(robust)
outreg2 using "$path/output/toiletpref_muslimshare.tex", append
summ toiletuse if e(sample)==1
reghdfe latrine_pref1 female c.muslim_share#c.female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toiletpref_muslimshare.tex", append
summ latrine_pref1 if e(sample)==1
reghdfe latrine_pref2 female c.muslim_share#c.female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toiletpref_muslimshare.tex", append
summ latrine_pref2 if e(sample)==1
reghdfe latrine_pref3 female c.muslim_share#c.female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toiletpref_muslimshare.tex", append see label tex(frag)
