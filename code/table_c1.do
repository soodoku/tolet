...
*Panel A
reghdfe toiletuse female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 1 & b2_3 != 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_SQUAT.tex", replace
reghdfe toiletuse female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 1 & b2_3 != 1, a(hhid e8) vce(robust)
outreg2 using "$path/output/toilterpref_SQUAT.tex", append
reghdfe latrine_pref1 female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_SQUAT.tex", append
reghdfe latrine_pref2 female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_SQUAT.tex", append
reghdfe latrine_pref3 female e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_SQUAT.tex", append see label

*Panel B
reghdfe toiletuse female muslimfemale muslim other e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 1 & b2_3 != 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_muslim_SQUAT.tex", replace
summ toiletuse if e(sample)==1
reghdfe toiletuse female muslimfemale muslim other e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 1 & b2_3 != 1, a(hhid e8) vce(robust)
outreg2 using "$path/output/toilterpref_muslim_SQUAT.tex", append
summ toiletuse if e(sample)==1
reghdfe latrine_pref1 female muslimfemale muslim other e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_muslim_SQUAT.tex", append
summ latrine_pref1 if e(sample)==1
reghdfe latrine_pref2 female muslimfemale muslim other e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_muslim_SQUAT.tex", append
summ latrine_pref2 if e(sample)==1
reghdfe latrine_pref3 female muslimfemale muslim other e11_a-e11_e e11_h e11_j e11_p e11_t ///
if b1_4_y_ >= 5 & b1_4_y_ <= 65 & g2_9 == 2 & b2_3 != 1 & selected == 1, a(villagecode e8) vce(robust)
outreg2 using "$path/output/toilterpref_muslim_SQUAT.tex", append see label
